...
var collectionsCreateCollectionV2Cmd = &cobra.Command{
	Use:   "create-collection-v2",
	Short: "Create Collection",
	RunE:  runCollectionsCreateCollectionV2,
}
...
func runCollectionsCreateCollectionV2(cmd *cobra.Command, args []string) error {
	...
	pathParams["collection_name"] = fmt.Sprintf("%v", collectionsCreateCollectionV2Flags.collectionName)
	...
	if collectionsCreateCollectionV2Flags.body != "" {
		if err := json.Unmarshal([]byte(collectionsCreateCollectionV2Flags.body), &bodyMap); err != nil {
	...
	if cmd.Flags().Changed("description") {
		bodyMap["description"] = collectionsCreateCollectionV2Flags.description
	}
	req.Body = bodyMap
