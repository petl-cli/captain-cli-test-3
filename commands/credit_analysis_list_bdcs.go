...
var creditAnalysisListBdcsCmd = &cobra.Command{
	Use:   "list-bdcs",
	Short: "List BDCs",
	RunE:  runCreditAnalysisListBdcs,
}
...
func runCreditAnalysisListBdcs(cmd *cobra.Command, args []string) error {
	...
	if rootFlags.schema {
		...
		responses = append(responses, responseSchema{
			...
			Description: "List of tracked BDCs",
		})

		schema := map[string]any{
			"command":     "list-bdcs",
			"description": "List BDCs",
			"http": map[string]any{
				"method": "GET",
				"path":   "/v2/datasets/odyssey/credit-analysis/bdc",
			},
	...
	req := &httpclient.Request{
		Method:      "GET",
		Path:        httpclient.SubstitutePath("/v2/datasets/odyssey/credit-analysis/bdc", pathParams),
