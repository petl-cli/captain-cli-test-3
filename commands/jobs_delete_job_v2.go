...
var jobsDeleteJobV2Cmd = &cobra.Command{
	Use:   "delete-job-v2",
	Short: "Delete Job",
	RunE:  runJobsDeleteJobV2,
}
...
func init() {
	...
	jobsCmd.AddCommand(jobsDeleteJobV2Cmd)
}

func runJobsDeleteJobV2(cmd *cobra.Command, args []string) error {
	...
	if rootFlags.schema {
		...
		flags = append(flags, flagSchema{
			...
			Required:    true,
			Location:    "path",
			Description: "The job ID to delete/cancel",
		})
	...
	pathParams["job_id"] = fmt.Sprintf("%v", jobsDeleteJobV2Flags.jobId)
