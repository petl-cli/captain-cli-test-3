...
var indexingIndexAzureContainerV2Cmd = &cobra.Command{
	Use:   "index-azure-container-v2",
	Short: "Index Azure Container",
	RunE:  runIndexingIndexAzureContainerV2,
}
...
func runIndexingIndexAzureContainerV2(cmd *cobra.Command, args []string) error {
	...
	if rootFlags.schema {
		...
		schema := map[string]any{
			"command":     "index-azure-container-v2",
			"description": "Index Azure Container",
			"http": map[string]any{
				"method": "POST",
				"path":   "/v2/collections/{collection_name}/index/azure",
			},
	...
	pathParams["collection_name"] = fmt.Sprintf("%v", indexingIndexAzureContainerV2Flags.collectionName)

	req := &httpclient.Request{
		Method:      "POST",
		Path:        httpclient.SubstitutePath("/v2/collections/{collection_name}/index/azure", pathParams),
	...
	if indexingIndexAzureContainerV2Flags.body != "" {
		if err := json.Unmarshal([]byte(indexingIndexAzureContainerV2Flags.body), &bodyMap); err != nil {
